...
use crate::kernel_ir::{
    ...
    routines::{
        ...
        simple::{SimpleAlgorithm, SimpleArgs, SimpleTmaAlgorithm, SimpleResidueFirstAlgorithm},
...
where
    RC: crate::kernel_ir::launch::RuntimeConfig,
    A: Routine<RC>,
{
...
impl Display for Strategy {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Strategy::SimpleCyclicCmmaResidueFirst => write!(f, "matmul_simple_cyclic_cmma_residue_first32"),
...
impl Strategy {
    pub(crate) fn launch_ref<R: Runtime>(
        ...
        match self {
            Strategy::SimpleCyclicCmmaResidueFirst => launch_tiling::launch_ref::<R, SimpleResidueFirstAlgorithm>(
