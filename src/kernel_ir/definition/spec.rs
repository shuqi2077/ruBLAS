...
use crate::kernel_ir::definition::MatmulIdent;
...
/// Arithmetic permitted for F32 inputs; other dtypes retain their own precision rules.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub enum F32MathMode {
    /// Do not automatically reduce F32 operands to a lower-precision format.
    #[default]
    Strict,
    /// Permit TF32 multiplication with F32 accumulation; F32 fallback is allowed.
    AllowTf32,
}

#[derive(Debug, Clone, Eq, PartialEq, Hash)]
pub struct MatmulElems {
    pub f32_math: F32MathMode,
...
impl MatmulElems {
    ...
    pub fn from_globals(global_elems: &MatmulGlobalElems) -> Self {
        ...
        Self {
            f32_math: global_elems.f32_math,
